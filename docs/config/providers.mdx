...
| zai-coding-plan       | `ZAI_BASE_URL`                 | Custom API endpoint |
| moonshot              | `MOONSHOT_BASE_URL`            | Custom API endpoint |
| minimax               | `MINIMAX_BASE_URL`             | Custom API endpoint |
| minimax-coding-plan   | `MINIMAX_BASE_URL`             | Custom API endpoint |
| xiaomi                | `XIAOMI_BASE_URL`              | Custom API endpoint |
| xiaomi-token-plan-sgp | `XIAOMI_BASE_URL`              | Custom API endpoint |
| xiaomi-token-plan-ams | `XIAOMI_BASE_URL`              | Custom API endpoint |
| alibaba               | `ALIBABA_BASE_URL`             | Custom API endpoint |
| alibaba-coding-plan   | `ALIBABA_CODING_PLAN_BASE_URL` | Custom API endpoint |
