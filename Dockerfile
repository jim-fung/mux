...
COPY scripts/generate-version.sh scripts/generate-builtin-agents.sh scripts/generate-builtin-skills.sh scripts/generate-builtin-workflow-actions.sh scripts/generate-builtin-workflows.sh scripts/
COPY scripts/gen_builtin_skills.ts scripts/gen_builtin_workflows.ts scripts/gen_builtin_workflow_actions.ts scripts/gen_workflow_runtime_sources.ts scripts/
COPY docs/ docs/
