...
export const modelsExtra: Record<string, ModelData> = {
  ...
  // ===========================================================================
  // OpenAI-compatible vendor models (Z.AI/Zhipu GLM, Moonshot Kimi, MiniMax,
  // Xiaomi MiMo, Alibaba Qwen). Pricing/caps sourced from each vendor's catalog.
  // Keyed by model name (matched via generateLookupKeys' direct-name key).
  // ===========================================================================
